...
/**
 * This class implements the large object interface to com.amazon.redshift.
 *
 * <p>It provides methods that allow client code to create, open and delete large objects from the
 * database. When opening an object, an instance of com.amazon.redshift.largeobject.LargeObject is
 ...
 *
 * <pre>
 * import com.amazon.redshift.largeobject.*;
 *
 * Connection  conn;
 ...
 *
 * lobj = ((com.amazon.redshift.RedshiftConnection)myconn).getLargeObjectAPI();
 * </pre>
 *
 ...
 *
 * <p>Refer to com.amazon.redshift.largeobject.LargeObject on how to manipulate the contents of a Large
 * Object.</p>
 *
...
public class LargeObjectManager {
  ...
  public LargeObjectManager(BaseConnection conn) throws SQLException {
    ...
    conn.getLogger().log(LogLevel.DEBUG, "Large Object initialised");
  }
  ...
  public LargeObject open(long oid, int mode, boolean commitOnClose) throws SQLException {
    if (conn.getAutoCommit()) {
      throw new RedshiftException(GT.tr("Large Objects may not be used in auto-commit mode."),
