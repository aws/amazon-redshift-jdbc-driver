...
public class RedshiftPooledConnection implements PooledConnection {
  ...
  public Connection getConnection() throws SQLException {
    if (con == null) {
      ...
      RedshiftException sqlException =
          new RedshiftException(GT.tr("This PooledConnection has already been closed."),
    ...
    try {
      ...
      /*
       * In XA-mode, autocommit is handled in RedshiftXAConnection, because it depends on whether an
    ...
    if (RedshiftLogger.isEnable())
    	((BaseConnection)con).getLogger().logFunction(false, proxyCon);
  ...
  private class ConnectionHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      if (con == null || con.isClosed()) {
        throw new RedshiftException(automatic
            ? GT.tr(
            ...
            : GT.tr("Connection has been closed."), RedshiftState.CONNECTION_DOES_NOT_EXIST);
      }
      ...
      try {
        if (methodName.equals("createStatement")) {
          ...
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{Statement.class, com.amazon.redshift.RedshiftStatement.class},
              new StatementHandler(this, st));
        } else if (methodName.equals("prepareCall")) {
          Statement st = (Statement) method.invoke(con, args);
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{CallableStatement.class, com.amazon.redshift.RedshiftStatement.class},
              new StatementHandler(this, st));
        } else if (methodName.equals("prepareStatement")) {
          Statement st = (Statement) method.invoke(con, args);
          return Proxy.newProxyInstance(getClass().getClassLoader(),
              new Class[]{PreparedStatement.class, com.amazon.redshift.RedshiftStatement.class},
              new StatementHandler(this, st));
        } else {
          return method.invoke(con, args);
        }
