 ...
 * Redshift ConnectionPoolDataSource implementation!</span> This class is provided as a
 ...
 * connection pooling, and use the Redshift implementation of ConnectionPoolDataSource to provide
 ...
 */
@Deprecated
public class RedshiftPoolingDataSource extends BaseDataSource implements DataSource {
  protected static ConcurrentMap<String, RedshiftPoolingDataSource> dataSources =
      new ConcurrentHashMap<String, RedshiftPoolingDataSource>();

  public static RedshiftPoolingDataSource getDataSource(String name) {
  ...
  private RedshiftConnectionPoolDataSource source;

  /**
   * Gets a description of this DataSource.
   */
  public String getDescription() {
    return "Pooling DataSource '" + dataSourceName + " from " + com.amazon.redshift.util.DriverInfo.DRIVER_FULL_NAME;
  }
  ...
  public void setDataSourceName(String dataSourceName) {
    ...
    RedshiftPoolingDataSource previous = dataSources.putIfAbsent(dataSourceName, this);
    if (previous != null) {
  ...
  public void initialize() throws SQLException {
    synchronized (lock) {
      ...
      try {
        ...
        throw new RedshiftException(GT.tr("Failed to setup DataSource."), RedshiftState.UNEXPECTED_ERROR,
            e);
      }
   ...
   */
  protected RedshiftConnectionPoolDataSource createConnectionPool() {
  ...
  private Connection getPooledConnection() throws SQLException {
    ...
    synchronized (lock) {
      if (available == null) {
        throw new RedshiftException(GT.tr("DataSource has been closed."),
