...
public enum RedshiftState {
  ...
  public static boolean isConnectionError(String psqlState) {
    return RedshiftState.CONNECTION_UNABLE_TO_CONNECT.getState().equals(psqlState)
        || RedshiftState.CONNECTION_DOES_NOT_EXIST.getState().equals(psqlState)
        || RedshiftState.CONNECTION_REJECTED.getState().equals(psqlState)
        || RedshiftState.CONNECTION_FAILURE.getState().equals(psqlState)
        || RedshiftState.CONNECTION_FAILURE_DURING_TRANSACTION.getState().equals(psqlState);
  }
