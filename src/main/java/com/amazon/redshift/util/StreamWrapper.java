...
public class StreamWrapper {
  ...
  private static final String TEMP_FILE_PREFIX = "redshift-rsjdbc-stream";
  ...
  public StreamWrapper(InputStream stream) throws RedshiftException {
    try {
