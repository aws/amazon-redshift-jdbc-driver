 ...
 * redshift.url.encoding} property</p>
 *
 * <p>Note: this should not be used outside of Redshift source, this is not a public API of the
 * driver.</p>
 */
public final class URLCoder {
  private static final String ENCODING_FOR_URL =
      System.getProperty("redshift.url.encoding", "UTF-8");
