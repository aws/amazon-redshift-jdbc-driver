...
public class RedshiftInterval extends RedshiftObject implements Serializable, Cloneable {
   ...
   */
  public RedshiftInterval(int years, int months, int days, int hours, int minutes, double seconds) {
    this();
  ...
  public void setValue(String value) throws SQLException {
    ...
    try {
      ...
      throw new RedshiftException(GT.tr("Conversion of interval failed"),
   ...
   */
  public void add(RedshiftInterval interval) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof RedshiftInterval)) {
      return false;
    }

    final RedshiftInterval pgi = (RedshiftInterval) obj;
