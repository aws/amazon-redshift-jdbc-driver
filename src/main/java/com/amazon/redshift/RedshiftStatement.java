...
/**
 * This interface defines the public Redshift extensions to java.sql.Statement. All Statements
 * constructed by the Redshift driver implement RedshiftStatement.
 */
public interface RedshiftStatement {
