...
public class messages_ru extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[53] = "Невозможно обработать RedshiftInterval: {0}";
    ...
    t[373] = "Не в состоянии ассоциировать значения параметров для команды (RedshiftBindException)";
