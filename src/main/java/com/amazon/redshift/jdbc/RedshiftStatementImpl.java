...
public class RedshiftStatementImpl implements Statement, BaseStatement {
  ...
  protected final void checkNoResultUpdate() throws SQLException {
    synchronized (this) {
      ...
      if (this.autoGeneratedKeys == Statement.NO_GENERATED_KEYS) {
  ...
  public boolean execute(String sql) throws SQLException {
    if (RedshiftLogger.isEnable()) 
    	connection.getLogger().logFunction(true, QuerySanitizer.filterCredentials(sql));
      ...
      if (wantsGeneratedKeysOnce || wantsGeneratedKeysAlways) {
      	if (result.getNext() != null) {
	        ...
	        result = result.getNext();
      		...
      		// PreparedStatement set Statement.RETURN_GENERATED_KEYS, but no RETURNING clause in sql      		
      		generatedKeys = null;
      	}
...
//          RedshiftState.NOT_IMPLEMENTED);
  ...
  public boolean execute(String sql, int autoGeneratedKeys) 
  				throws SQLException {
    if (RedshiftLogger.isEnable()) 
    	connection.getLogger().logFunction(true, QuerySanitizer.filterCredentials(sql), autoGeneratedKeys);
  ...
  public boolean execute(String sql, int[] columnIndexes) throws SQLException {
    if (RedshiftLogger.isEnable()) 
    	connection.getLogger().logFunction(true, QuerySanitizer.filterCredentials(sql), columnIndexes);
  ...
  public boolean execute(String sql, String[] columnNames) throws SQLException {
    ...
    if (RedshiftLogger.isEnable()) 
    	connection.getLogger().logFunction(true, QuerySanitizer.filterCredentials(sql), columnNames);
