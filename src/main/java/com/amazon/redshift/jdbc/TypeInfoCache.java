...
public class TypeInfoCache implements TypeInfo {
  ...
  private static final Object[][] types = {
      ...
      {"time with time zone", Oid.TIMETZ, Types.TIME_WITH_TIMEZONE, "java.sql.Time", Oid.TIMETZ_ARRAY},
      ...
      {"timestamp with time zone", Oid.TIMESTAMPTZ, Types.TIMESTAMP_WITH_TIMEZONE, "java.sql.Timestamp", Oid.TIMESTAMPTZ_ARRAY},
      {"timestamptz", Oid.TIMESTAMPTZ, Types.TIMESTAMP_WITH_TIMEZONE, "java.sql.Timestamp", Oid.TIMESTAMPTZ_ARRAY},
